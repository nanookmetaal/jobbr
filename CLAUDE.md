...
|---|---|---|
| `NEXT_PUBLIC_API_URL` | Yes | Full URL of the deployed backend, e.g. `https://jobbr-hazel.vercel.app`. No trailing slash. |
...
4. Add environment variable:
   - `NEXT_PUBLIC_API_URL` = your backend's production URL (e.g. `https://jobbr-hazel.vercel.app`)
5. Deploy
